...
const ScheduleRepository = {
  ...
  getShowtimes: async (
    ...
    const query = `select TIME_FORMAT(showtime, '%H:%i') as showtime from schedules s WHERE studio_id = ${getShowtimes.studio_id} AND showdate = '${getShowtimes.showdate}' ORDER BY showtime`;
